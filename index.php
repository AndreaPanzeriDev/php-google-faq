...
<html lang="en">
    ...
    <body>
        <header>
            <div>
                <div class="d-flex">
                    <img class="logo" src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="logo">
                    <p class="policy">Privacy e termini</p>
                </div>
            </div>
            <div class="d-flex">
                <p class="info">Introduzione</p>
                <p class="info"> Norme sulla privacy</p>
                <p class="info">Termini di servizi</p>
                <p class="info">Tecnologie</p>
                <p class="info">Domande frequenti</p>
            </div>
        </header>
